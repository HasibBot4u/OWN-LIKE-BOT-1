...
# ============ CONFIGURATION ============
API_URL = "https://like-omega-nine.vercel.app/"
ENCODED_KEY = "WkVYWFk="
API_KEY = base64.b64decode(ENCODED_KEY).decode()

BOT_TOKEN = "8807461143:AAHh5RkKRdldWvHedwyLZqJEVgvqJEBukuY"
ADMIN_IDS = [7950033441]          # ← Replace with your actual admin ID(s)
